...
class SaturdayAdapter: RecyclerView.Adapter<SaturdayAdapter.SaturdayHolder>() {
    ...
    class SaturdayHolder(item: View, listener: OnItemClickListener) : RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SaturdayHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.workout_item, parent, false)
        return SaturdayHolder(view, mListener)
    }

    override fun onBindViewHolder(holder: SaturdayHolder, position: Int) {
