...
class WorkoutAdapter: RecyclerView.Adapter<WorkoutAdapter.WorkoutHolder>() {
    ...
    class WorkoutHolder(item: View, listener: OnItemClickListener): RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WorkoutHolder {
        ...
        return WorkoutHolder(view, mListener)
    }
