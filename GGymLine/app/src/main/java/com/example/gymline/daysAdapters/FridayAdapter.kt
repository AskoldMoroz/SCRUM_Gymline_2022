...
class FridayAdapter: RecyclerView.Adapter<FridayAdapter.FridayHolder>() {
    ...
    class FridayHolder(item: View, listener: OnItemClickListener) : RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FridayHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.workout_item, parent, false)
        return FridayHolder(view, mListener)
    }

    override fun onBindViewHolder(holder: FridayHolder, position: Int) {
