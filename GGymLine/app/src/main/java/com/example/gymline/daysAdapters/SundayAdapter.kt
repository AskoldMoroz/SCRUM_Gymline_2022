...
class SundayAdapter: RecyclerView.Adapter<SundayAdapter.SundayHolder>() {
    ...
    class SundayHolder(item: View, listener: OnItemClickListener) : RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SundayHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.workout_item, parent, false)
        return SundayHolder(view, mListener)
    }

    override fun onBindViewHolder(holder: SundayHolder, position: Int) {
