...
class WednesdayAdapter: RecyclerView.Adapter<WednesdayAdapter.WednesdayHolder>() {
    ...
    class WednesdayHolder(item: View, listener: OnItemClickListener) : RecyclerView.ViewHolder(item) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WednesdayHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.workout_item, parent, false)
        return WednesdayHolder(view, mListener)
    }

    override fun onBindViewHolder(holder: WednesdayHolder, position: Int) {
